...
import 'package:alzrelief/screens/alzheimer_user/home/Activity_Manager/expenses%20manager/expense_home.dart';
import 'package:alzrelief/screens/alzheimer_user/home/Activity_Manager/Personal%20Diary/note_screen.dart';
...
class CoginativePage extends StatefulWidget {
  const CoginativePage({super.key});

  @override
  State<CoginativePage> createState() => _CoginativePageState();
}

class _CoginativePageState extends State<CoginativePage> {
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [                                                                               
                            ...
                            TapNavigation(
                              destination: const ExpensesHome(),
                              child: HomePageTile(
                                height: 87,
                                width: 100,
                                icon: null,
