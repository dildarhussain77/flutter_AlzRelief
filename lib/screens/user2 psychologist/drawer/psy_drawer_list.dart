...
import 'package:alzrelief/screens/user2%20psychologist/drawer/profile/psy_profile.dart';
import 'package:alzrelief/screens/sign%20in%20with%20google/sign_in_with_google_Role.dart';
import 'package:flutter/material.dart';

class PsychologistMyDrawerList extends StatefulWidget {
  const PsychologistMyDrawerList({super.key});

  @override
  State<PsychologistMyDrawerList> createState() => _PsychologistMyDrawerListState();
}

class _PsychologistMyDrawerListState extends State<PsychologistMyDrawerList> {
        ...
        onTap: (){
          ...
          setState((){
            if(id == 1){
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PsychologistProfilePage()), // Replace `LoginPage` with your login page widget
              );
